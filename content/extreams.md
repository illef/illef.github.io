...
양서 『틀리지 않는 법』(조던 앨런버그, 열린책들) 의 1장은 "오바마는 왜 미국을 더 스웨덴스럽게 만드려고 애쓰는가? 스웨덴 사람들마저 덜 스웨덴스러워지려고 애쓰는 마당에?" 라는 대니얼 J. 미첼의 말을 인용하며 시작한다. 이 발언의 문제점을 찾을 수 있는가? 문제를 찾기 어렵다면 다음 발언을 생각해보자. "그렇게 할 거면 공산주의 하지 왜? ㅋㅋㅋ" 문제점을 찾을 수 있겠는가? 두 발언 모두 같은 방식으로 세상을 본다. 

{{ image(path="liner.png", desc="대니얼 J. 미첼의 선형 세상" width=300, op="fit_width") }}

대니얼이 바라보는 세상은 선형으로 회귀된다. x축은 스웨덴 스러움이고 y축은 모종의 번영 수준이다. "그렇게 할 거면 공산주의 하지 왜? ㅋㅋㅋ" 라는 말도 같은 방식으로 세상을 본다. **선형 세상에서 y 축이 가장 높은 지점은 직선이 가진 성질에 의해 이쪽이든 저쪽이든 극단의 한쪽 끝이다.**

그러나 지나치게 많은 복지도 있고 지나치게 적은 복지도 있다. 지나치게 많은 규제도 있고 지나치게 적은 규제도 있다. 너무 많이 먹는 것도 건강에 좋지 않고 너무 적게 먹는 것도 마찬가지로 좋지 않다. 증거 없는 믿음은 인지 부조화로 끝나고, 모든 믿음에 필요 이상의 증명을 요구하는 태도는 회의주의로 끝난다. 오른쪽의 끝은 파시즘이며 왼쪽의 끝은 이해 조율의 포기와 경제적 파산이라는 논리적 귀결이다. 수학을 불변의 진리라고 생각하는 것도 문제지만 수학의 기초에 불확실성이 있다 해서 수학을 자연에 응용함으로써 얻을 수 있는 수 많은 이점을 포기하는 것은 완전히 미친 짓이다. 세상은 아래와 같은 비선형 곡선으로 가득하다.

{{ image(path="non-linear.png", width=300, op="fit_width") }}

극단을 추구하는 사람은 원하는 방향이 다를 지라도 비선형으로 이뤄진 세상을 선형으로 본다는 점에서 같다. 선형 세상에선 올바른 행동이 오직 방향으로 결정된다. 비선형 세상에서 어느 쪽으로 가야 하는지 선택하기 위해서는 우리가 지금 어디에 있느냐를 확인해야 한다. x 축 위 현재 위치를 고려해야 한다는 지난한 과정을 회피하고자 사람들은 비선형 세상을 선형으로 보고 자기도 모른 채 극단주의자가 된다.
...
권력과 동떨어진 극단은 세상을 다채롭게 만든다. 따라서 모든 극단을 제거해선 안되며 권력과 거리가 먼 사람이 행하는 극단적 행동은 사회의 큰 해가 되지 않으므로 품어주어야 한다. 조직 내 몇 명의 극단주의자는 당면한 문제를 다른 방식으로 보는 데 도움이 되기에 완전히 내쳐서는 안된다. 하지만 그들이 권력의 높은 곳에 올라가지 못하게 막아야 한다. 스티븐 레비츠키의 말을 들어보자.
...
외부의 인기를 얻은 극단주의자를 제도권으로 들이다 못해 대통령으로 만들어버린 우리의 무지함으로 여기 저기 난장판이다. 약자가 행한 극단에는 가혹하게 반응하지만 권력자가 행하는 극단은 관용하는 시스템이 서글프다. 그날로 부터 100일여가 지난 오늘도 극단을 몰아내지 못함에 무력하다.
